...
public:
  ...
  Statistics() {
    ...
    registerStat("l1_evictions", 0);
    registerStat("l1_eviction_hits", 0);
    registerStat("l1_eviction_misses", 0);
    ...
    registerStat("l1_rmws", 0);
    registerStat("l1_rmw_hits", 0);
    registerStat("l1_rmw_misses", 0);
    registerStat("l1_rmw_misses_full", 0);
    registerStat("l1_rmw_misses_merged", 0);
    ...
    registerStat("l2_evictions", 0);
    registerStat("l2_eviction_hits", 0);
    registerStat("l2_eviction_misses", 0);
    ...
    registerStat("l2_rmws", 0);
    registerStat("l2_rmw_hits", 0);
    registerStat("l2_rmw_misses", 0);
    registerStat("l2_rmw_misses_full", 0);
    registerStat("l2_rmw_misses_merged", 0);
    ...
    registerStat("llc_local_accesses", 0);
    registerStat("llc_remote_accesses", 0);
    ...
    registerStat("l3_evictions", 0);
    registerStat("l3_eviction_hits", 0);
    registerStat("l3_eviction_misses", 0);
    ...
    registerStat("l3_rmws", 0);
    registerStat("l3_rmw_hits", 0);
    registerStat("l3_rmw_misses", 0);
    registerStat("l3_rmw_misses_full", 0);
    registerStat("l3_rmw_misses_merged", 0);
    ...
    registerStat("l1_cache_invalidations", 1);
    registerStat("l1_cache_invalidations_dirty", 1);
    registerStat("l1_cache_invalidations_clean", 1);
    registerStat("l1_cache_invalidations_full", 1);
    registerStat("l1_cache_invalidations_full_dirty", 1);
    registerStat("l1_cache_invalidations_full_clean", 1);
    registerStat("l1_cache_invalidations_merged", 1);
    registerStat("l1_cache_invalidations_merged_dirty", 1);
    registerStat("l1_cache_invalidations_merged_clean", 1);
    registerStat("l2_cache_invalidations", 1);
    registerStat("l2_cache_invalidations_dirty", 1);
    registerStat("l2_cache_invalidations_clean", 1);
    registerStat("l2_cache_invalidations_full", 1);
    registerStat("l2_cache_invalidations_full_dirty", 1);
    registerStat("l2_cache_invalidations_full_clean", 1);
    registerStat("l2_cache_invalidations_merged", 1);
    registerStat("l2_cache_invalidations_merged_dirty", 1);
    registerStat("l2_cache_invalidations_merged_clean", 1);

    // DRAM Stats
    registerStat("dram_accesses", 1);
    registerStat("dram_accesses_bypass", 1);
    registerStat("dram_accesses_l1_bypass", 1);
    registerStat("dram_accesses_l2_bypass", 1);
    registerStat("dram_accesses_l3", 1);
    registerStat("dram_accesses_bypass_evicts", 1);
    registerStat("dram_accesses_l1_bypass_evicts", 1);
    registerStat("dram_accesses_l2_bypass_evicts", 1);
    registerStat("dram_accesses_l3_evicts", 1);
    registerStat("dram_accesses_bypass_forwarded_evicts", 1);
    registerStat("dram_accesses_l1_bypass_forwarded_evicts", 1);
    registerStat("dram_accesses_l2_bypass_forwarded_evicts", 1);
    registerStat("dram_accesses_l3_forwarded_evicts", 1);
    registerStat("dram_accesses_rmw_evicts", 1);
    registerStat("dram_accesses_back_invalidations", 1);
